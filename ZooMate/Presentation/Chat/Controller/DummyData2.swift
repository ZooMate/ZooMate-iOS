...
//    private let dummyPets = DummyData1().dummyPets
//    
//    var chatRooms: [ChatRoom] {
//        [
//            ChatRoom(id: 1, pets: getPets([1, 6]), createdAt: Date()),
//            ChatRoom(id: 2, pets: getPets([2, 6]), createdAt: Date().addingTimeInterval(-86400)),
//            ChatRoom(id: 3, pets: getPets([3, 6]), createdAt: Date().addingTimeInterval(-172800)),
//            ChatRoom(id: 4, pets: getPets([4, 6]), createdAt: Date().addingTimeInterval(-259200)),
//            ChatRoom(id: 5, pets: getPets([5, 6]), createdAt: Date().addingTimeInterval(-345600)),
//        ]
//    }
//    
//    private func getPets(_ ids: [Int]) -> [Pet] {
//        dummyPets.filter { ids.contains($0.id) }
//    }
//    
