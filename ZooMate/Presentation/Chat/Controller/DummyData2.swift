...
class DummyData2: ObservableObject {
    let chatRooms: [ChatRoom] = [
        ...
        let messages: [Message] = [
            ...
            Message(msgId: "msg-4", senderPetId: "6", receiverPetId: "2", roomId: "room-2", content: "좋아요! 어디 다녀왔나요?", sendMsgAt: Date().addingTimeInterval(-88000)),
            
            // room-3
            Message(msgId: "msg-5", senderPetId: "3", receiverPetId: "6", roomId: "room-3", content: "우리 강아지 새 옷 샀어요.", sendMsgAt: Date().addingTimeInterval(-170000)),
            Message(msgId: "msg-6", senderPetId: "6", receiverPetId: "3", roomId: "room-3", content: "멋지네요! 사진 보여주세요.", sendMsgAt: Date().addingTimeInterval(-169000)),
            
            // room-4
            Message(msgId: "msg-7", senderPetId: "4", receiverPetId: "6", roomId: "room-4", content: "강아지 훈련 잘 되고 있나요?", sendMsgAt: Date().addingTimeInterval(-258000)),
            Message(msgId: "msg-8", senderPetId: "6", receiverPetId: "4", roomId: "room-4", content: "네! 조금씩 배우고 있어요.", sendMsgAt: Date().addingTimeInterval(-257000)),
            
            // room-5
            Message(msgId: "msg-9", senderPetId: "5", receiverPetId: "6", roomId: "room-5", content: "우리 강아지 놀러 올래요?", sendMsgAt: Date().addingTimeInterval(-344000)),
            Message(msgId: "msg-10", senderPetId: "6", receiverPetId: "5", roomId: "room-5", content: "네, 좋아요! 일정 잡아봐요.", sendMsgAt: Date().addingTimeInterval(-343000)),
        ]
}
