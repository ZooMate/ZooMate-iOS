...
let cityDistricts: [String: [String]] = [
    "서울특별시": [
    ...
    "세종특별자치시": [
        "조치원읍", "금남면", "부강면", "연기면", "연동면", "연서면", "장군면", "전의면", "전동면", "소정면",
        "한솔동", "새롬동", "도담동", "아름동", "종촌동", "고운동", "보람동", "대평동", "소담동", "반곡동"
    ],
    "경기도": [
        "수원시", "성남시", "고양시", "용인시", "부천시", "안산시", "남양주시", "화성시", "평택시", "의정부시",
        "시흥시", "파주시", "김포시", "광주시", "하남시", "이천시", "안성시", "오산시", "군포시", "의왕시",
        "양주시", "구리시", "안양시", "동두천시", "과천시", "포천시", "여주시", "양평군", "가평군", "연천군"
    ],
    "강원특별자치도": [
