...
class DummyData1: ObservableObject {
    let dummyPets: [Pet] = [
        ...
        Pet(id: 12, petName: "하늘", age: 3, gender: .female, isNeutering: false, isPublic: true, breed: "러시안블루", weight: 4.0, tag: ["조용함", "우아함"], photos: ["https://images.unsplash.com/photo-1479134262046-a470bfaf7a66?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .cat, ownerId: 12),
        Pet(id: 13, petName: "밤비", age: 1, gender: .female, isNeutering: false, isPublic: true, breed: "치와와", weight: 2.5, tag: ["작고 귀여움"], photos: ["https://images.unsplash.com/photo-1605630574100-cff6f7d2a948?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .dog, ownerId: 13),
        Pet(id: 14, petName: "구름", age: 4, gender: .male, isNeutering: true, isPublic: false, breed: "샤페이", weight: 8.0, tag: ["주름많음", "충성심"], photos: ["https://images.unsplash.com/photo-1664473404140-e6c388fffe75?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .dog, ownerId: 14),
        Pet(id: 15, petName: "별이", age: 2, gender: .female, isNeutering: true, isPublic: true, breed: "스코티시폴드", weight: 3.2, tag: ["귀접힘", "온순함"], photos: ["https://images.unsplash.com/photo-1685377507301-e01b4c17e1f0?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .cat, ownerId: 15),
        Pet(id: 16, petName: "탄이", age: 3, gender: .male, isNeutering: false, isPublic: true, breed: "시바이누", weight: 9.0, tag: ["독립적", "활발함"], photos: ["https://images.unsplash.com/photo-1678869848634-9a17e71023c9?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .dog, ownerId: 16),
        Pet(id: 17, petName: "몽이", age: 5, gender: .female, isNeutering: true, isPublic: true, breed: "믹스견", weight: 6.0, tag: ["다정함", "순함"], photos: ["https://images.unsplash.com/photo-1528919632209-de1db1493d97?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .dog, ownerId: 17),
        Pet(id: 18, petName: "라라", age: 2, gender: .female, isNeutering: false, isPublic: true, breed: "아메리칸숏헤어", weight: 3.8, tag: ["활발함", "사교적"], photos: ["https://images.unsplash.com/photo-1638667168631-f915859b80bc?q=80&w=2680&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .cat, ownerId: 18),
        Pet(id: 19, petName: "보리", age: 4, gender: .male, isNeutering: true, isPublic: false, breed: "말티즈", weight: 4.5, tag: ["애교많음", "소형견"], photos: ["https://images.dog.ceo/breeds/maltese/n02085936_10073.jpg"], category: .dog, ownerId: 19),
        Pet(id: 20, petName: "하니", age: 3, gender: .female, isNeutering: true, isPublic: true, breed: "개구리", weight: 4.0, tag: ["활동적", "호기심많음"], photos: ["https://images.unsplash.com/photo-1534062518571-b4d839eac102?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"], category: .reptile, ownerId: 20)
    ]
